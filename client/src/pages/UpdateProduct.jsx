      ...
      <div className="h-[350px] mt-10 flex justify-center items-center">
        <form class="w-[390px] mt-50 h-15 bg-orange rounded-lg shadow-lg" action="">
          <div className="rounded border border-blue-700 p-5 w-[390px] h-[390px]">
            ...
            <h1 className="text-3xl font-bold text-center text-white font-mono">Update Product</h1>
            {/*... */}
            <div className="flex gap-3 m-8">
              <label className="block uppercase tracking-wide text-xs font-bold mb-2 font-mono" for="grid-first-name">Product ID: </label>
            ...
            <div className="flex gap-3 m-5">
              <label className="text-xs font-bold font-mono">New Product Name: </label>
            ...
            <div className="flex gap-3 m-5">
              <label className="text-xs font-bold font-mono">New Quantity: </label>
            ...
            <div className="flex gap-3 m-5">
              <label className="text-xs font-bold font-mono">New Unit: </label>
            ...
            <div className="flex gap-3 m-5">
              <label className="text-xs font-bold font-mono">New Price: </label>
            ...
            <div className="flex justify-center">
              <button onClick={handleUpdate} className="py-1 px-5 bg-blue-500 text-white p-5 ml-auto rounded hover:bg-blue-400 hover:text-white m-2 font-mono">Update</button>
            </div>
          </div>
        </form>
      </div>
