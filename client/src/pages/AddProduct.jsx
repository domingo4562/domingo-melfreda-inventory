  ...
  return (
    <>
      <div className="h-[245px] flex mt-30 justify-center  items-center">
        <form class="w-[390px] mt-50 h-15 bg-purple-100" action="">
          <div className="rounded border border-blue-700 p-5 w-[390px] h-[370px]">
            ...
            <div className="flex justify-center">
              ...
              <button onClick={handleCancel} className="py-1 px-5 bg-red-500 text-white p-5 rounded hover:bg-red-400 hover:text-white m-2 ml-auto">Cancel</button>
            </div>
